  ...
  return (
    <View>
      ...
      <View style={[styles.mainUI, { backgroundColor: isDarkMode ? "#1E1E1E" : "#f2f2f2" }]}>
        ...
        <Text style={[styles.made, { color: isDarkMode ? "#fff" : "#414141" }]}>Find TODA nearby</Text>
        <Text style={[styles.hassle, { color: isDarkMode ? "#fff" : "#414141" }]}>San ka ba sasakay kasi</Text>

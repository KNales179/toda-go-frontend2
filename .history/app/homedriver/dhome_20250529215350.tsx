  ...
  const handleConfirmPayment = async () => {
    try {
      ...
      if (res.ok) {
        ...
        // ✅ Reset everything for next transaction
        setConfirmed(false);
        setIncomingBooking(null);
        setPickedUp(false);
        ...
        // ✅ Remove passenger markers on the map
        if (mapRef.current) {
          ...
          <TouchableOpacity
            ...
            onPress={async () => {
              try {
                ...
                if (res.ok) {
                  Alert.alert("✅ Payment Confirmed", "Booking marked as completed!");
                  // ✅ Reset everything for next booking
                  setPaymentConfirm(false);
                  setPickedUp(false);
                  setConfirmed(false);
                  setIncomingBooking(null);

...
export default function TabsLayout() {
  return (
    ...
    >
      <Tab.Screen name="phome" component={DHome} options={{ title: "Home" }} />
      <Tab.Screen name="phistory" component={DHistory} options={{ title: "History" }} />
      <Tab.Screen name="pchats" component={DChats} options={{ title: "Chats" }} />
      <Tab.Screen name="pprofile" component={DProfile} options={{ title: "Profile" }} />
    </Tab.Navigator>
  );
}

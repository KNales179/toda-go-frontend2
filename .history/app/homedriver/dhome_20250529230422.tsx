...
export default function DHome() {
  ...
  return (
    <View style={styles.container}>
      ...
      {incomingBooking && !confirmed && !minimized && (
        <View style={styles.popup}>
          ...
          <TouchableOpacity onPress={() => setMinimized(true)}>
            <Text style={{marginTop: 10, padding: 5, backgroundColor: "#81C3E1", color: 'white', borderRadius: 5, textAlign: 'center'}}>Minimize</Text>
          </TouchableOpacity>
        </View>
      )}
      ...
      {minimized && (
        <TouchableOpacity
          style={{ position: "absolute", bottom: 50, left: 20, backgroundColor: "white", padding: 10, borderRadius: 8 }}

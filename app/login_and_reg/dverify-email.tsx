...
export default function DVerifyEmail() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/auth/driver/verify-email-otp`,
        {
          method: "POST",
      ...
      Alert.alert(
        "Email Verified",
        data?.message ||
          "Your email has been verified. Please wait for admin verification.",
        [
          {
            text: "Go to Login",
      ...
      console.error("handleVerifyOtp driver error:", error);
      Alert.alert(
        "Verification Failed",
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/auth/driver/resend-email-otp`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
      ...
      console.error("handleResendOtp driver error:", error);
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          ...
          <Text style={[styles.subtitle, { color: colors.muted }]}>
            Enter the 6-digit code sent to your email. After email verification,
            your driver account will still be reviewed by the admin.
          </Text>
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => router.replace("/login_and_reg/dregister")}
            >
